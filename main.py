...
from MICE_Imputation import handle_missing_value
from variable_outliers import vt_outliers
...
class ACRPS:
    def __init__(self,path):
        try:
            self.path = path
            self.df = pd.read_csv(self.path) # load the data into a variable
...
if __name__ == '__main__':
    try:
        obj = ACRPS('Telco-Customer-Churn.csv')
        obj.missing_values()
        obj.data_separation()
